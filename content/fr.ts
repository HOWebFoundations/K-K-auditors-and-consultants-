...
const fr: DeepPartial<Dictionary> = {
    ...
    sectors: [
      {
        ...
        intro: [
          "Pour les industriels et les producteurs, tout repose sur une comptabilité analytique précise. Maîtriser l'imputation des frais généraux, la valorisation des en-cours de production et des produits finis, voilà ce qui distingue une marge fiable d'une simple estimation, et c'est précisément là qu'un audit rigoureux apporte le plus de valeur.",
          "K&K met à profit une expérience de terrain auprès des usines et des importateurs libanais, en associant l'audit des états financiers à la discipline de TVA, de douane et de gestion des stocks dont les entreprises de production dépendent pour protéger leurs marges et rassurer leurs prêteurs.",
        ],
        offerings: [
          "Audit légal et audit de groupe des entreprises industrielles et manufacturières",
          "Revue des coûts standard, de l'imputation des frais généraux et des en-cours de production",
          "Inventaires physiques, valorisation des stocks et provisions pour obsolescence",
          "Vérification des installations, du matériel et des immobilisations, et politique d'amortissement",
          "Traitement de la TVA, de la douane et des droits à l'import pour les matières premières et les produits finis",
        ],
        considerations: [
          "Une valorisation des stocks cohérente et justifiable d'un exercice à l'autre",
          "La juste immobilisation des actifs industriels et des coûts d'emprunt",
          "La récupération de la TVA sur les intrants importés et la détaxation des exportations",
          "La séparation des tâches entre achats, production et magasins",
        ],
      },
      {
        ...
        intro: [
          "La comptabilité de la construction et de l'immobilier repose sur la comptabilisation des produits. La méthode à l'avancement, les retenues de garantie, les avenants et les provisions pour contrats déficitaires façonnent tous le résultat publié bien avant la livraison d'un projet.",
          "K&K audite les entrepreneurs, les promoteurs et les foncières sur l'ensemble du cycle de vie du projet, en alignant la comptabilisation des produits et des charges sur la taxe foncière bâtie libanaise et sur le reporting attendu par les banques et les partenaires de coentreprise.",
        ],
        offerings: [
          "Audit des entrepreneurs, des promoteurs et des sociétés foncières",
          "Revue des produits selon la méthode à l'avancement et des contrats à long terme",
          "Comptabilisation des retenues de garantie, des avenants et des réclamations",
          "Conformité à la taxe foncière bâtie et à l'impôt sur les revenus locatifs",
          "Contrôle des coûts de projet et reporting des coentreprises",
        ],
        considerations: [
          "Une mesure fiable du degré d'avancement des contrats et du coût restant à engager",
          "Les provisions pour contrats déficitaires et obligations de garantie",
          "La taxe foncière bâtie et l'impôt sur les plus-values de cession",
          "Les flux de trésorerie et les clauses financières de financement sur des projets de longue durée",
        ],
      },
      {
        ...
        intro: [
          "Les cliniques, les laboratoires et les distributeurs pharmaceutiques détiennent des stocks de grande valeur, souvent périssables, doublés d'une facturation aux tiers complexe. Des contrôles solides sur les stocks, les revenus et les opérations avec les parties liées sont essentiels tant à la fiabilité des comptes qu'à la conformité réglementaire.",
          "K&K accompagne ses clients de la santé et de la pharmacie par un audit et un conseil qui respectent le suivi des lots, la gestion des péremptions et la confidentialité qu'exige le secteur.",
        ],
        offerings: [
          "Audit des cliniques, hôpitaux, laboratoires et distributeurs pharmaceutiques",
          "Contrôles des stocks intégrant le suivi des lots, des péremptions et de la chaîne du froid",
          "Revue des revenus et des créances auprès des assureurs et des tiers payeurs",
          "Revue des parties liées et des prix de transfert pour les structures de groupe",
          "Accompagnement de la conformité réglementaire, des agréments et de la tenue des registres",
        ],
        considerations: [
          "La valorisation et le provisionnement des stocks à date courte et périmés",
          "La comptabilisation des créances sur les assureurs et les tiers payeurs",
          "Les prix pratiqués entre parties liées au sein des groupes de distribution",
          "La confidentialité des données et le registre des substances réglementées",
        ],
      },
      {
        ...
        intro: [
          "Les ONG rendent des comptes à leurs donateurs et aux autorités en même temps. La comptabilité des fonds affectés, les budgets de subvention et la vérification des dépenses doivent être irréprochables pour que les financements se poursuivent et que les réputations demeurent intactes.",
          "K&K audite des ONG libanaises et internationales, en réalisant des audits de conformité des subventions et des audits de projet qui satisfont les bailleurs institutionnels, les ambassades et les agences des Nations Unies tout en respectant les exigences locales.",
        ],
        offerings: [
          "Audit légal et audit de projet pour les ONG et les associations",
          "Comptabilité des fonds affectés par les donateurs et des fonds non affectés",
          "Audits de conformité des subventions et de vérification des dépenses",
          "Revue des achats et du contrôle interne pour les programmes financés",
          "Reporting adapté aux bailleurs institutionnels et multilatéraux",
        ],
        considerations: [
          "La classification correcte des fonds affectés et non affectés",
          "L'éligibilité des dépenses au titre des conventions de subvention",
          "Les règles d'achat imposées par les bailleurs",
          "Le reporting multidevise et multi-bailleurs",
        ],
      },
      {
        ...
        intro: [
          "Les courtiers, les négociants et les institutions financières évoluent sous une surveillance réglementaire étroite, où la ségrégation des fonds clients et l'adéquation des fonds propres ne se négocient pas et où l'indépendance est primordiale.",
          "K&K propose aux acteurs des services financiers un audit et une assurance dotés de la rigueur, de la confidentialité et de la vigilance réglementaire que le secteur requiert.",
        ],
        offerings: [
          "Audit des courtiers, des négociants et des institutions financières",
          "Revue des contrôles sur les fonds clients et la séparation des fonds",
          "Accompagnement du reporting réglementaire et de l'adéquation des fonds propres",
          "Revue de la comptabilisation des revenus, des commissions et des honoraires",
          "Évaluation de l'indépendance et du contrôle interne",
        ],
        considerations: [
          "La séparation et le rapprochement des fonds clients",
          "La juste valeur des instruments financiers",
          "Les fonds propres réglementaires et les échéances de reporting",
          "Les contrôles de lutte contre le blanchiment et de connaissance du client",
        ],
      },
      {
        ...
        intro: [
          "Les hôtels, les complexes touristiques et les lieux d'accueil fonctionnent avec de forts volumes de transactions, une manipulation d'espèces importante et une saisonnalité marquée. L'assurance des revenus et une planification rigoureuse de la trésorerie empêchent une bonne saison de masquer une année faible.",
          "K&K aide les exploitants de l'hôtellerie et des loisirs à resserrer les contrôles sur les revenus, à traiter correctement les frais de service et les pourboires, et à anticiper les variations de trésorerie qui caractérisent le secteur.",
        ],
        offerings: [
          "Audit des hôtels, complexes touristiques, restaurants et lieux de divertissement",
          "Assurance des revenus sur l'hébergement, la restauration, les boissons et les événements",
          "Revue des contrôles sur la manipulation des espèces et les points de vente",
          "Traitement des frais de service, des pourboires et de la paie",
          "Planification de la trésorerie saisonnière et du fonds de roulement",
        ],
        considerations: [
          "L'exhaustivité des revenus en espèces et par carte à fort volume",
          "Le traitement correct des frais de service et des pourboires",
          "Les contrôles des stocks de nourriture et de boissons",
          "Le financement saisonnier et la couverture du besoin en fonds de roulement",
        ],
      },
      {
        ...
        intro: [
          "Les distributeurs, les détaillants et les franchisés se livrent concurrence sur des marges faibles et des stocks à rotation rapide. Une analyse claire des marges et un traitement rigoureux de la TVA et des droits à l'import protègent la rentabilité de toute érosion.",
          "K&K audite les entreprises de négoce et de distribution et les conseille sur la TVA, la douane et le reporting de franchise qui maintiennent les chaînes d'approvisionnement transfrontalières conformes et efficaces.",
        ],
        offerings: [
          "Audit des distributeurs, grossistes, détaillants et franchisés",
          "Analyse de la marge brute et de la rotation des stocks",
          "Revue de la TVA à l'import, des droits de douane et du coût de revient à l'arrivée",
          "Reporting de franchise, de redevances et d'agence",
          "Revue des créances, du contrôle du crédit et des pertes de stock",
        ],
        considerations: [
          "Une valorisation exacte du coût de revient à l'arrivée et des stocks",
          "La récupération de la TVA à l'import et la classification tarifaire",
          "La conformité des redevances et des droits de franchise",
          "Les contrôles de la démarque, des retours et des avoirs",
        ],
      },
      {
        ...
        intro: [
          "Les structures de holding et offshore existent pour détenir, financer et coordonner d'autres sociétés, et le Liban offre des régimes spécifiques de holding et d'offshore, dotés de leur propre traitement fiscal et de leurs propres obligations de reporting.",
          "K&K consolide les groupes, audite les entités holding et offshore, et conseille sur la structuration transfrontalière afin que la détention soit efficace, conforme et clairement présentée.",
        ],
        offerings: [
          "Audit et reporting consolidés de groupe",
          "Conformité des sociétés holding et offshore libanaises",
          "Structuration transfrontalière et revue des conventions fiscales",
          "Opérations intragroupe, de dividendes et de financement",
          "Accompagnement en matière de substance, de gouvernance et de bénéficiaire effectif",
        ],
        considerations: [
          "L'éligibilité aux régimes libanais des holdings et de l'offshore",
          "Les prix intragroupe et la sous-capitalisation",
          "La retenue à la source sur les dividendes et intérêts transfrontaliers",
          "La substance économique et la déclaration du bénéficiaire effectif",
        ],
      },
    ],
    sectorOfferingsTitle: "Comment nous aidons",
    sectorConsiderationsTitle: "Points de vigilance",
    sectorExploreLabel: "Explorer le secteur",
    sectorRelatedTitle: "Les autres secteurs que nous servons",
    sectorIntroKicker: "Expertise sectorielle",
    industryKicker: "Expertise par secteur",
    ...
    industries: [
      {
        ...
        intro: [
          "Les industriels libanais achètent leurs matières premières à l'étranger et vendent sur un marché où les coûts des intrants et la devise évoluent plus vite que les prix, ce qui place la valorisation des stocks et la comptabilité analytique au cœur de chaque jeu de comptes. Les droits de douane, la TVA à l'import et l'amortissement des installations et du matériel pèsent directement sur les marges publiées.",
          "K&K aide les industriels à mettre en place une comptabilité analytique et des contrôles de stocks rigoureux, puis les audite en portant une attention particulière aux marges dans un contexte de volatilité des coûts d'intrants. Notre équipe rapproche les registres douaniers, la TVA et les données de production afin que les résultats publiés résistent à l'examen.",
        ],
        offerings: [
          "Audit légal centré sur les inventaires physiques, les en-cours de production et le coût des marchandises vendues",
          "Systèmes de coûts standard et analyse des marges par produit",
          "Récupération de la TVA sur les intrants importés et détaxation des exportations",
          "Registre des immobilisations et plans d'amortissement des installations et du matériel",
          "Conformité NSSF et paie pour l'ensemble du personnel de production",
        ],
        considerations: [
          "La méthode de valorisation des stocks et les provisions pour obsolescence en cas de volatilité de la devise",
          "La classification tarifaire et les droits de douane sur les matières premières et les pièces de rechange",
          "Les déductions pour amortissement fiscal et le calendrier d'amortissement du matériel",
        ],
      },
      {
        slug: "real-estate",
        title: "Immobilier",
        intro: [
          "Les acteurs de l'immobilier au Liban couvrent la promotion, les portefeuilles locatifs et les syndicats de copropriété, chacun avec son propre rythme comptable autour des ventes sur plan, des livraisons échelonnées et des longues durées de détention. La taxe foncière bâtie sur les revenus locatifs, les droits d'enregistrement et les plus-values de cession façonnent à la fois la trésorerie et le résultat publié.",
          "K&K accompagne les promoteurs, les bailleurs et les syndicats de copropriété sur la comptabilisation des produits, la taxe foncière bâtie et la planification des cessions. Nous structurons le reporting pour que les partenaires financiers et les acquéreurs disposent de chiffres clairs et fiables.",
        ],
        offerings: [
          "Audit des projets de promotion et comptabilisation des produits sur les lots vendus",
          "Calcul de la taxe foncière bâtie sur les revenus locatifs et de location",
          "Impôt sur les plus-values et taxe de cession sur les transferts de biens",
          "Modélisation de la trésorerie et structuration du financement des programmes",
          "Comptabilité des syndicats de copropriété et des charges communes",
        ],
        considerations: [
          "La taxe foncière bâtie sur les revenus locatifs et les allègements disponibles",
          "Le moment de la comptabilisation des produits sur les ventes sur plan et les livraisons échelonnées",
          "Les droits d'enregistrement et les plus-values générées par les transferts",
        ],
      },
      {
        slug: "healthcare",
        title: "Santé",
        intro: [
          "Les hôpitaux, les cliniques et les laboratoires portent des créances importantes sur la NSSF, le ministère de la Santé publique et les assureurs privés, souvent réglées selon des cycles longs et irréguliers. La plupart des services médicaux échappent à la TVA, ce qui n'est pas nécessairement le cas des prestations accessoires, si bien que cette frontière exige une attention constante.",
          "K&K audite les établissements de soins avec un soin particulier pour le provisionnement des créances et la limite entre prestations exonérées et prestations taxables. Nous aidons la direction à discerner le coût et la marge réels par service au-delà du bruit des remboursements.",
        ],
        offerings: [
          "Audit centré sur les créances auprès des tiers payeurs et le provisionnement des remboursements",
          "Comptabilisation des honoraires des médecins et des accords de partage de revenus",
          "Traitement de la TVA sur les services médicaux exonérés et les prestations accessoires taxables",
          "Comptabilité analytique par service et amortissement des équipements médicaux de grande valeur",
          "Conformité de la paie et de la NSSF pour le personnel soignant et administratif",
        ],
        considerations: [
          "Le provisionnement des remboursements de tiers lents ou contestés",
          "La frontière de TVA entre les prestations médicales et non médicales",
          "L'amortissement et le financement des équipements médicaux coûteux",
        ],
      },
      {
        slug: "ngos",
        title: "Organismes à but non lucratif / ONG",
        intro: [
          "Les organismes à but non lucratif au Liban gèrent des fonds affectés par les donateurs, des subventions en plusieurs devises et des obligations de reporting qui diffèrent d'un bailleur à l'autre. Le statut non lucratif ne supprime pas les obligations de paie, de NSSF et de retenue à la source, et il relève les exigences de suivi et de justification des fonds.",
          "K&K réalise des audits de projet et des audits légaux qui satisfont à la fois les conditions des bailleurs et la loi locale, en s'appuyant sur le réseau GMN International pour les bailleurs transfrontaliers. Nous bâtissons des cadres de comptabilité des fonds et de contrôle qui résistent à la revue des donateurs.",
        ],
        offerings: [
          "Audits de projet et audits par subvention menés selon les termes des bailleurs",
          "Comptabilité des fonds distinguant les ressources affectées et non affectées",
          "Reporting financier aux bailleurs et états de comparaison entre budget et réalisé",
          "Paie, NSSF et retenue à la source pour le personnel local et expatrié",
          "Contrôle interne sur la trésorerie et les achats des fonds de subvention",
        ],
        considerations: [
          "Le suivi des fonds affectés et les conditions de conformité des bailleurs",
          "La conversion des subventions en devises et le traitement des écarts de change",
          "L'impôt sur les salaires et la NSSF sur le personnel local et expatrié",
        ],
      },
      {
        ...
        intro: [
          "Les cabinets d'avocats, les cabinets de conseil et les agences facturent au temps passé et à la mission, portant des travaux en cours et des produits non facturés qui doivent être comptabilisés avec soin. Le partage des bénéfices entre associés, les prélèvements et la retenue à la source sur les honoraires transfrontaliers ajoutent des strates supplémentaires aux comptes.",
          "K&K, en tant qu'experts-comptables assermentés et membres de la LACPA, aide les cabinets à mesurer la rentabilité des missions et à comptabiliser proprement la rémunération des associés. Nous maintenons les travaux en cours, la facturation et la fiscalité transfrontalière sur une base cohérente.",
        ],
        offerings: [
          "Audit et examen des travaux en cours et des produits non facturés",
          "Comptabilisation du partage des bénéfices entre associés et des prélèvements",
          "TVA sur les honoraires de services nationaux et transfrontaliers",
          "Retenue à la source sur les paiements aux sous-traitants non-résidents",
          "Reporting de la rentabilité des missions et du taux d'utilisation du personnel",
        ],
        considerations: [
          "La comptabilisation des produits sur les travaux en cours et les missions longues",
          "La retenue à la source sur les honoraires professionnels transfrontaliers",
          "L'immatriculation à la TVA et le lieu de prestation pour les services exportés",
        ],
      },
      {
        slug: "entertainment",
        ...
        intro: [
          "Les productions, les festivals et les événements reposent sur des budgets de projet, des recettes de billetterie et de parrainage, des redevances et des paiements à des artistes souvent non-résidents. Les revenus arrivent par à-coups et de plusieurs sources à la fois, ce qui rend indispensable un suivi budgétaire rigoureux.",
          "K&K met de l'ordre dans les budgets de projet, le rapprochement de la billetterie et les paiements aux talents étrangers. Nous veillons à ce que la retenue à la source et la TVA soient traitées avant la clôture de l'événement, et non après.",
        ],
        offerings: [
          "Audit des budgets de production et d'événements avec suivi détaillé des coûts",
          "Retenue à la source sur les cachets versés aux artistes étrangers",
          "Rapprochement des recettes de guichet, de billetterie et de parrainage",
          "Comptabilisation des redevances et des revenus de propriété intellectuelle",
          "TVA sur la vente de billets, le parrainage et les produits dérivés",
        ],
        considerations: [
          "La retenue à la source sur les artistes et les équipes non-résidents",
          "La comptabilisation des produits sur la billetterie, le parrainage et les redevances",
          "Le traitement de la TVA sur les événements, le parrainage et les produits dérivés",
        ],
      },
      {
        slug: "brokers-dealers",
        title: "Courtiers / Négociants",
        intro: [
          "Les courtiers et les négociants tirent leurs revenus des commissions et des écarts de cotation (spread) tout en détenant des fonds de clients qui doivent rester strictement séparés des leurs. Le reporting aux régulateurs tels que la Capital Markets Authority et l'imposition des revenus de capitaux mobiliers constituent des obligations récurrentes.",
          "K&K audite les revenus de commissions et d'écarts et teste les contrôles qui assurent la ségrégation des fonds clients. Nous aidons les courtiers à répondre aux attentes des régulateurs sans ralentir la salle de marché.",
        ],
        offerings: [
          "Audit de la comptabilisation des revenus de commissions et d'écarts",
          "Revue de la ségrégation des fonds clients et des contrôles de rapprochement",
          "Accompagnement du reporting réglementaire et auprès de la Capital Markets Authority",
          "Imposition des revenus de capitaux mobiliers et retenue à la source associée",
          "Revue de la lutte contre le blanchiment et du contrôle interne",
        ],
        considerations: [
          "La ségrégation et le rapprochement quotidien des fonds clients",
          "Le moment de la comptabilisation des revenus de commissions et d'écarts",
          "Les fonds propres réglementaires et les obligations de reporting périodique",
        ],
      },
      {
        slug: "distributors",
        title: "Distributeurs",
        intro: [
          "Les distributeurs importent et vendent en gros dans le cadre de contrats d'agence et de représentation exclusive, immobilisant des capitaux dans les stocks et dans les créances sur le commerce de détail. Le coût de revient à l'arrivée, les droits de douane, la TVA à l'import et les paiements aux commettants étrangers influent tous sur la marge réelle de chaque ligne.",
          "K&K vérifie le coût de revient à l'arrivée, les marges et le provisionnement des stocks sur toute la chaîne d'approvisionnement. Nous maintenons la TVA à l'import et la retenue à la source sur les commettants étrangers exactes et dans les délais.",
        ],
        offerings: [
          "Audit des stocks, des marges brutes et du coût des marchandises vendues",
          "Traitement de la TVA sur les importations et la distribution nationale",
          "Vérification des droits de douane et du coût de revient à l'arrivée par expédition",
          "Gestion des créances et exposition au risque de crédit sur le commerce de détail",
          "Retenue à la source sur les paiements aux commettants et fournisseurs étrangers",
        ],
        considerations: [
          "Le coût de revient à l'arrivée et les droits de douane sur les marchandises importées",
          "Le provisionnement des stocks à rotation lente et périmés",
          "Le décalage de TVA entre les importations et les ventes nationales",
        ],
      },
      {
        slug: "engineering-design",
        title: "Ingénierie et conception",
        intro: [
          "Les cabinets d'ingénierie et de conception facturent par jalons, retiennent des garanties et portent des projets qui s'étendent sur de nombreux mois ou années. Leurs membres s'inscrivent à l'Ordre des ingénieurs et des architectes, et les honoraires techniques transfrontaliers font entrer la retenue à la source en jeu.",
          "K&K valorise les travaux en cours et les retenues de garantie de façon réaliste et présente la marge projet par projet. Nous tenons en ordre la retenue à la source sur les honoraires transfrontaliers et les obligations envers l'ordre professionnel.",
        ],
        offerings: [
          "Audit de la facturation par jalons et des retenues de garantie à recevoir",
          "Reporting des produits et des marges projet par projet",
          "Valorisation des travaux en cours et appréciation du degré d'avancement",
          "Retenue à la source sur les honoraires de conception et d'ingénierie transfrontaliers",
          "Conformité de la paie, de la NSSF et des cotisations professionnelles",
        ],
        considerations: [
          "Les retenues de garantie à recevoir et le provisionnement sur les projets longs",
          "La comptabilisation des produits selon le degré d'avancement",
          "La retenue à la source sur les honoraires techniques transfrontaliers",
        ],
      },
      {
        slug: "financial-services",
        title: "Services financiers",
        intro: [
          "Les banques, les institutions financières, les sociétés de crédit-bail et les bureaux de change opèrent sous la réglementation de la Banque du Liban, appliquant le provisionnement IFRS et les règles d'adéquation des fonds propres dans une période de tensions systémiques profondes. Les produits d'intérêts, les pertes de crédit attendues et les taux de change multiples pèsent lourdement sur les comptes.",
          "K&K audite selon les attentes de la Banque du Liban et applique le provisionnement IFRS avec un jugement adapté à des tensions prolongées. Nous aidons les institutions à présenter de façon crédible leurs fonds propres et leurs expositions au risque de crédit.",
        ],
        offerings: [
          "Audits légaux et réglementaires alignés sur les circulaires de la Banque du Liban",
          "Travaux sur les pertes de crédit attendues et le provisionnement selon IFRS 9",
          "Accompagnement de l'adéquation des fonds propres et du reporting réglementaire",
          "Imposition des produits d'intérêts et des revenus de capitaux mobiliers",
          "Revue du contrôle interne et de la lutte contre le blanchiment",
        ],
        considerations: [
          "Le provisionnement des pertes de crédit attendues dans un contexte de tensions prolongées",
          "La conformité aux circulaires de la Banque du Liban et le reporting réglementaire",
          "L'exposition aux devises à travers des taux de change multiples",
        ],
      },
      {
        slug: "franchisees",
        title: "Franchisés",
        intro: [
          "Les franchisés exercent dans le cadre de contrats de marque qui exigent un droit d'entrée de franchise initial, des redevances continues et un reporting régulier des ventes à un franchiseur à l'étranger. Ces flux de redevances entraînent des obligations de retenue à la source, tandis que les droits acquis doivent être amortis sur leur durée.",
          "K&K vérifie que les redevances et les droits de franchise sont calculés et retenus correctement, et que le reporting des ventes correspond aux termes du franchiseur. Nous fournissons aux exploitants des chiffres fiables par point de vente pour piloter leur activité.",
        ],
        offerings: [
          "Audit du calcul des redevances et des droits de franchise",
          "Retenue à la source sur les redevances et droits versés aux franchiseurs étrangers",
          "Rapprochement du reporting des ventes avec les exigences du franchiseur",
          "TVA, NSSF et paie pour le personnel des points de vente",
          "Reporting de la rentabilité et du contrôle des coûts par point de vente",
        ],
        considerations: [
          "La retenue à la source sur les redevances versées aux franchiseurs étrangers",
          "L'amortissement des droits d'entrée de franchise et des droits acquis",
          "L'exactitude du reporting du chiffre d'affaires brut pour le calcul des redevances",
        ],
      },
      {
        slug: "holding-companies",
        title: "Sociétés holding",
        intro: [
          "Les sociétés holding constituées sous la Loi n° 45 sont exonérées d'impôt sur le revenu au titre de leurs bénéfices et imposées à la place sur le capital et les réserves, sous réserve d'un plafond. Elles détiennent des participations, consentent des prêts intragroupe et perçoivent des dividendes, autant d'éléments qui doivent être comptabilisés et consolidés avec soin.",
          "K&K applique le régime de la Loi n° 45 avec précision et tient au propre les soldes intragroupe et les participations. Nous préparons des comptes consolidés et des comptes individuels qui reflètent fidèlement le groupe.",
        ],
        offerings: [
          "Audit des comptes consolidés et individuels des sociétés holding",
          "Application du régime fiscal des sociétés holding au titre de la Loi n° 45",
          "Comptabilisation des dividendes, des participations et des prêts intragroupe",
          "Calcul de l'impôt assis sur le capital et de l'impôt forfaitaire",
          "Conseil en structuration de groupe et rapprochement intragroupe",
        ],
        considerations: [
          "Les conditions du régime et le plafond de l'impôt assis sur le capital",
          "La retenue à la source sur les intérêts des prêts intragroupe aux filiales",
          "La substance et l'éligibilité des activités au titre de la Loi n° 45",
        ],
      },
      {
        slug: "offshore-companies",
        title: "Sociétés offshore",
        intro: [
          "Les sociétés offshore immatriculées sous la Loi n° 46 exercent leur activité hors du Liban et acquittent un impôt annuel forfaitaire fixe en lieu et place de l'impôt sur le revenu. Leurs activités doivent rester dans le périmètre offshore autorisé, et la plupart des opérations sont libellées en devises.",
          "K&K maintient les entités offshore dans le périmètre de la Loi n° 46 et dépose l'impôt forfaitaire fixe dans les délais. Nous prenons en charge la comptabilité multidevise et la documentation qui sous-tend l'activité de source étrangère.",
        ],
        offerings: [
          "Audit et comptes annuels des entités offshore",
          "Application du régime fiscal offshore de la Loi n° 46",
          "Dépôt de l'impôt annuel forfaitaire fixe",
          "Contrôles de conformité des activités offshore autorisées",
          "Comptabilité multidevise et reporting des opérations en devises",
        ],
        considerations: [
          "Le maintien dans les activités offshore autorisées par la Loi n° 46",
          "L'impôt forfaitaire fixe et l'impôt sur les salaires du personnel local",
          "La substance et la documentation des opérations de source étrangère",
        ],
      },
      {
        slug: "hotels-resorts",
        title: "Hôtels et complexes touristiques",
        intro: [
          "Les hôtels et les complexes touristiques exploitent plusieurs départements générateurs de revenus à la fois, l'hébergement, la restauration et les événements, dans une saisonnalité marquée. La taxe municipale sur l'hébergement, la TVA et la répartition des frais de service côtoient de lourds investissements en immobilisations.",
          "K&K audite par département et présente les marges sur l'hébergement, la restauration et les événements. Nous veillons à ce que la taxe municipale, la TVA et la répartition des frais de service soient correctement traitées tout au long de la saison.",
        ],
        offerings: [
          "Audit par département sur l'hébergement, la restauration et les événements",
          "Reporting hôtelier uniforme et analyse des marges par département",
          "TVA et taxe municipale sur l'hébergement et les services",
          "Comptabilisation de la répartition des frais de service et des pourboires",
          "Paie et NSSF pour le personnel permanent et saisonnier",
        ],
        considerations: [
          "La taxe municipale et la TVA sur les revenus des chambres et des événements",
          "La répartition des frais de service et son traitement en paie",
          "L'immobilisation des travaux de rénovation et l'amortissement des actifs",
        ],
      },
      {
        slug: "contractors",
        title: "Entrepreneurs de construction",
        intro: [
          "Les entrepreneurs de construction livrent des projets de longue durée financés par la facturation à l'avancement et les avances, avec des retenues de garantie prélevées et des garanties de bonne exécution en place. La comptabilité à l'avancement et la fiabilité des estimations du coût restant à engager déterminent le résultat publié.",
          "K&K teste les estimations d'avancement et le coût restant à engager au regard de la réalité du chantier. Nous maintenons les retenues de garantie, les garanties et la TVA sur la facturation à l'avancement correctement enregistrées.",
        ],
        offerings: [
          "Audit de la comptabilisation des produits et des coûts des contrats à long terme",
          "Comptabilité à l'avancement et des retenues de garantie",
          "TVA sur la facturation à l'avancement et les avances",
          "Retenue à la source sur les paiements aux sous-traitants et aux consultants étrangers",
          "Revue de la comptabilité par chantier, des garanties et des provisions",
        ],
        considerations: [
          "Les estimations d'avancement et l'exactitude du coût restant à engager",
          "Les retenues de garantie à recevoir et les provisions pour garanties de bonne exécution",
          "Le décalage de TVA sur la facturation à l'avancement et les avances",
        ],
      },
      {
        slug: "retail-trade",
        ...
        intro: [
          "Les détaillants traitent d'importants volumes de transactions en espèces et par carte sur un ou plusieurs points de vente, sur des marges faibles et avec une exposition constante à la démarque inconnue. La TVA est facturée au point de vente et doit être rapprochée fréquemment des systèmes de caisse et des déclarations.",
          "K&K rapproche les données des points de vente avec le grand livre et examine la démarque et la marge sur l'ensemble des points de vente. Nous resserrons les contrôles de caisse et maintenons des déclarations de TVA propres à grande échelle.",
        ],
        offerings: [
          "Audit des revenus des points de vente et des contrôles de caisse",
          "Inventaires physiques, analyse de la démarque et revue des marges",
          "Rapprochement de la TVA entre les systèmes de caisse et les déclarations",
          "Reporting et consolidation multi-magasins",
          "Paie et NSSF pour le personnel de vente et saisonnier",
        ],
        considerations: [
          "La démarque inconnue et le provisionnement des stocks",
          "Le rapprochement de la TVA entre les points de vente et les déclarations",
          "Les contrôles de manipulation des espèces sur plusieurs points de vente",
        ],
      },
      {
        slug: "gas-stations",
        ...
        intro: [
          "Les stations-service opèrent sur des marges réglementées et de forts volumes, la plupart des ventes se faisant en espèces et les stocks étant mesurés par jaugeage des cuves, sujet à l'évaporation. Le rapprochement des livraisons, des relevés de pompe et du stock physique est au cœur de l'environnement de contrôle.",
          "K&K rapproche les livraisons, le jaugeage des cuves et les relevés de pompe pour mettre au jour les pertes et protéger la marge. Nous renforçons les contrôles de caisse là où les volumes sont élevés et majoritairement en espèces.",
        ],
        offerings: [
          "Audit des volumes de carburant, des rapprochements de cuves et des relevés de pompe",
          "Analyse des marges sur le carburant réglementé et les ventes de la boutique",
          "Rapprochement de la TVA et des contrôles de caisse",
          "Provisionnement des pertes de stock et de l'évaporation",
          "Paie, NSSF et reporting par station",
        ],
        considerations: [
          "Le rapprochement du jaugeage des cuves et les pertes par évaporation",
          "Les contrôles de caisse face à des ventes à fort volume et en espèces",
          "Le suivi des marges sous un prix du carburant réglementé",
        ],
      },
      {
        ...
        intro: [
          "Les importateurs, les distributeurs et les fabricants de produits pharmaceutiques opèrent sous le régime des prix du ministère de la Santé publique, de l'enregistrement des produits, de la traçabilité des lots et d'une gestion stricte des péremptions. Les marges réglementées et les prix contrôlés laissent peu de place à l'erreur sur les stocks et les revenus.",
          "K&K audite le provisionnement des lots et des péremptions et teste la conformité aux prix réglementés. Nous maintenons exactes la douane, la TVA et les paiements aux commettants étrangers.",
        ],
        offerings: [
          "Audit des stocks par lot, des péremptions et du provisionnement associé",
          "Analyse des marges réglementées et de la conformité des prix",
          "Traitement de la TVA et de la douane des médicaments importés",
          "Revue de la chaîne du froid et du contrôle des stocks",
          "Retenue à la source sur les paiements aux commettants étrangers",
        ],
        considerations: [
          "Le provisionnement des péremptions et des lots sur les stocks réglementés",
          "Les prix du ministère de la Santé publique et les contrôles des marges",
          "La TVA et la classification douanière des médicaments",
        ],
      },
      {
        slug: "representation-offices",
        title: "Bureaux de représentation",
        intro: [
          "Un bureau de représentation fait la promotion de sa société mère étrangère sans réaliser de ventes commerciales au Liban, fonctionnant comme un centre de coûts financé par la maison mère. Son reporting porte donc sur la paie, la justification des dépenses et le maintien dans une vocation non commerciale.",
          "K&K maintient le bureau dans sa vocation non commerciale et justifie le financement par la maison mère. Nous gérons l'impôt sur les salaires, la NSSF et les déclarations annuelles qui gardent l'immatriculation en règle.",
        ],
        offerings: [
          "Audit du remboursement des dépenses et du financement par la maison mère",
          "Impôt sur les salaires et NSSF pour le personnel local et détaché",
          "Suivi de la conformité du statut de représentation non commerciale",
          "Retenue à la source sur les paiements éligibles",
          "Comptes légaux et déclarations annuelles",
        ],
        considerations: [
          "Le maintien dans une activité de représentation non commerciale",
          "L'impôt sur les salaires des salariés locaux et détachés",
          "La justification des dépenses financées par la maison mère",
        ],
      },
      {
        slug: "pet-companies",
        title: "Entreprises animalières",
        intro: [
          "Les entreprises animalières combinent la vente d'aliments et d'accessoires avec des services vétérinaires, de toilettage et de pension, mêlant sous un même toit des revenus de biens et de services. Les produits importés et les stocks périssables à date de péremption ajoutent une réelle complexité aux stocks et à la TVA.",
          "K&K sépare les revenus de biens de ceux de services pour un traitement correct de la TVA et un reporting fidèle des marges. Nous gardons sous contrôle les stocks périssables, les importations et la paie multisites.",
        ],
        offerings: [
          "Audit des flux de revenus mixtes, biens et services",
          "Contrôle des stocks d'aliments, de médicaments et d'accessoires pour animaux",
          "Traitement de la TVA sur les produits, les services vétérinaires et le toilettage",
          "Douane et droits à l'import sur les produits pour animaux",
          "Paie, NSSF et reporting multisites",
        ],
        considerations: [
          "La ventilation de la TVA entre les biens et les services vétérinaires ou de toilettage",
          "Le provisionnement des produits périssables et des péremptions sur les aliments et les médicaments",
          "Les droits de douane sur les produits pour animaux importés",
        ],
      },
    ],
  ...
  careers: {
    ...
    areas: [
      ...
      { title: "Comptabilité", body: "Des comptables assurant un reporting de gestion et financier fiable." },
      { title: "Conseil", body: "Des analystes et conseillers en évaluation, études de faisabilité et transactions." },
    ],
