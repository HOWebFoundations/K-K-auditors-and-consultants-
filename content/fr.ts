...
const fr: DeepPartial<Dictionary> = {
  ...
  careers: {
    ...
    applyTitle: "Postuler",
    applySubtitle: "Parlez-nous de vous et du domaine qui vous intéresse, puis envoyez votre CV — un associé examinera votre candidature.",
    form: {
      position: "Domaine d'intérêt",
      selectArea: "Choisissez un domaine",
      cvNote: "Après l'envoi, merci d'adresser votre CV à info@kandkauditors.com en indiquant votre nom en objet.",
      successTitle: "Merci — votre candidature a bien été reçue.",
      successBody: "Merci d'envoyer votre CV à info@kandkauditors.com. Un associé de K&K l'examinera et vous recontactera.",
    },
